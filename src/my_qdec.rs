...
use microbit::hal::gpio::{Floating, Input, OpenDrainIO, Pin, PullDown, PullUp};
use microbit::hal::pac::QDEC;

// marker trait for input pin
pub trait InputPinState {}

// all of the input pin types?
impl InputPinState for Floating {}
impl InputPinState for PullUp {}
impl InputPinState for PullDown {}
impl InputPinState for OpenDrainIO {}
...
{
    qdec: QDEC,
    _phantom_pins: PhantomData<Pins<T>>,
}
    ...
    T: InputPinState,
{
    ...
    pub fn new(qdec: QDEC, pins: Pins<T>, sample_period: SamplePeriod) -> Self
    where
        T: InputPinState,
    {
        qdec.psel.a.write(|w| {
